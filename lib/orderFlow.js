...
//
// Each step gates on the field it needs before it can be entered. Only
// placement and dispatch email the customer (ZeptoMail, spec §15) — the
// "being packed" and "delivered" notices were dropped to keep it to two
// messages per order. Cancellation is available from any pre-delivery state.
// ==========================================================================
...
export const STEPS = {
    ...
    requires: [
      {
        ...
        hint: "Generates the PDF invoice, attached to the dispatch email.",
        mono: true,
      },
    ],
  },
  Shipped: {
    ...
    email: {
      ...
      blurb: "Dispatch notice with carrier, tracking and the invoice PDF.",
    },
  },
  Delivered: {
