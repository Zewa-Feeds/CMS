...
export const NAV = [
  ...
  { label: "Customers", href: "/customers", icon: "Users", perm: "customers.view" },
  {
    ...
    icon: "Coins",
    perm: "loyalty.view",
    // `sub`, not `children` — Sidebar.jsx reads `n.sub` (lines 26, 72, 124).
    // Under the wrong key `hasSub` was false and this whole submenu never
    // rendered: Balances, Liability, Risk and Rules were all unreachable from
    // the rail, not just Give Coins.
    sub: [
      { label: "Balances", href: "/loyalty" },
      { label: "Give Coins", href: "/loyalty/give", perm: "loyalty.adjust" },
      { label: "Liability", href: "/loyalty/liability" },
      { label: "Risk", href: "/loyalty/risk" },
      { label: "Rules", href: "/loyalty/rules", perm: "loyalty.config" },
    ],
  },
  {
    label: "Content",
  ...
  },
  {
    ...
    sub: [
      ...
      { label: "Add Influencer", href: "/influencers/new" },
    ],
  },
  {
    label: "Reviews",
